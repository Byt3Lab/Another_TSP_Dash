...
const DepartureForm = () => {
  ...
  const [lateEarningValue, setLateEarningValue] = useState("");
  const [lateEarning, setLateEarning] = useState("");
      ...
      <div className="w-full flex mb-4 p-1 items-center">
        ...
        <div className="flex items-center border-2 border-gray-700 py-2 px-3 rounded-2xl w-full">
          ...
          <input
            ...
            name="lateTime"
            id="lateTime"
            placeholder="How Late You Stayed ?"
            required
            disabled
            contentEditable="false"
      ...
      <div className="w-full flex mb-4 p-1 items-center">
        <div className="flex items-center border-2 border-gray-700 py-2 px-3 rounded-2xl w-full">
          ...
          <input
            className="pl-2 outline-none border-none w-full bg-transparent text-gray-700 font-bold"
            type="number"
            name="lateEarningValue"
            id="lateEarningValue"
            placeholder="Earning Amount Unit"
            required
            disabled
            contentEditable="false"
            onChange={(e) => setLateEarningValue(e.target.value)}
          />
        </div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div className="flex items-center border-2 py-2 px-3 border-gray-700 rounded-2xl w-full">
          ...
          <input
            ...
            disabled
            contentEditable="false"
            onChange={(e) => setLateEarning(e.target.value)}
          />
        </div>
      </div>
