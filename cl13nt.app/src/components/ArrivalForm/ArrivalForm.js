...
const ArrivalForm = (props) => {
  ...
  const [lateDebitValue, setLateDebitValue] = useState("");
  const [lateDebit, setLateDebit] = useState("");
      ...
      <div className="w-full flex mb-4 p-1 items-center">
        <div className="flex items-center border-2 border-gray-700 py-2 px-3 rounded-2xl w-full">
          ...
          <input
            ...
            disabled
            contentEditable="false"
            onChange={(e) => setArrHour(e.target.value)}
          />
        </div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div className="flex items-center border-2 border-gray-700 py-2 px-3 rounded-2xl w-full">
      ...
      <div className="w-full flex mb-4 p-1 items-center">
        <div className="flex items-center border-2 border-gray-700 py-2 px-3 rounded-2xl w-full">
          ...
          <input
            ...
            disabled
            contentEditable="false"
            onChange={(e) => setLateDebitValue(e.target.value)}
          />
        </div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div className="flex items-center border-2 py-2 px-3 border-gray-700 rounded-2xl w-full">
          ...
          <input
            ...
            disabled
            contentEditable="false"
            onChange={(e) => setLateDebit(e.target.value)}
          />
        </div>
      </div>
